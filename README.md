...
* Alguns momentos, durante o acrescimo de exp do pokemon do jogador, depois de um batalha, está sendo se tendo um ganho muito alto de experiência (maior que a % settada em increaseExp).